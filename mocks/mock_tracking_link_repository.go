...
// Source: domain/repository/tracking_links.go
...
func (m *MockTrackingLinksRepositoryInterface) FindTrackingLink(slug string) *entity.TrackingLink {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FindTrackingLink", slug)
	ret0, _ := ret[0].(*entity.TrackingLink)
	return ret0
}

// FindTrackingLink indicates an expected call of FindTrackingLink.
func (mr *MockTrackingLinksRepositoryInterfaceMockRecorder) FindTrackingLink(slug interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FindTrackingLink", reflect.TypeOf((*MockTrackingLinksRepositoryInterface)(nil).FindTrackingLink), slug)
}
